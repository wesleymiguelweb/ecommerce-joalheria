...
class ProductController extends Controller
{
    ...
    {
        $products = $this->getDemoProducts()->where('category', 'feminino')->values();
        return view('feminino', compact('products'));
    }

    public function masculino()
    {
        $products = $this->getDemoProducts()->where('category', 'masculino')->values();
        return view('masculino', compact('products'));
    }

    public function show($id)
    {
        $product = $this->getDemoProducts()->firstWhere('id', (int)$id);

        if (!$product) {
            $product = $this->getDemoProducts()->first();
        }
